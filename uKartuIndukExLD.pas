...
var
  fKartuIndukExLD: TfKartuIndukExLD;
...
procedure TfKartuIndukExLD.UpdateKartuInduk(vBerkasID, vOPID,
...
procedure TfKartuIndukExLD.FormCreate(Sender: TObject);
begin
  fWait.Show;
...
procedure TfKartuIndukExLD.FormResize(Sender: TObject);
var
  tLebar : Integer;
begin
...
procedure TfKartuIndukExLD.FormShow(Sender: TObject);
var
  tLebar : Integer;
begin
...
procedure TfKartuIndukExLD.cxButton8Click(Sender: TObject);
begin
  QOP1.Close;
...
procedure TfKartuIndukExLD.bGetDataKIClick(Sender: TObject);
var
  vOP : integer;
  total, cetak : integer;
begin
...
procedure TfKartuIndukExLD.cxGrid1DBTableView1StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
...
procedure TfKartuIndukExLD.cxGridDBTableView1StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  if (ARecord is TcxGridDataRow) and (ARecord.Values[2] = 1) then
...
procedure TfKartuIndukExLD.cxGridDBTableView2StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  if (ARecord is TcxGridDataRow) and (ARecord.Values[2] = 1) then
...
procedure TfKartuIndukExLD.cxGridDBTableView3StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  if (ARecord is TcxGridDataRow) and (ARecord.Values[2] = 1) then
...
procedure TfKartuIndukExLD.bPembuatanBPKBDuplikatClick(Sender: TObject);
begin
...
procedure TfKartuIndukExLD.cxButton1Click(Sender: TObject);
begin
  if (uniSPBiru.Active) and (uniSPBiru.RecordCount > 0) then
  begin
...
procedure TfKartuIndukExLD.cxButton2Click(Sender: TObject);
begin
...
procedure TfKartuIndukExLD.cxButton3Click(Sender: TObject);
begin
  if (uniSPHijau.Active) and (uniSPHijau.RecordCount > 0) then
  begin
...
procedure TfKartuIndukExLD.cxButton4Click(Sender: TObject);
begin
...
procedure TfKartuIndukExLD.cxButton5Click(Sender: TObject);
begin
  if (uniSPKuning.Active) and (uniSPKuning.RecordCount > 0) then
  begin
...
procedure TfKartuIndukExLD.cxButton6Click(Sender: TObject);
begin
...
procedure TfKartuIndukExLD.cxButton7Click(Sender: TObject);
begin
  if (uniSPMerah.Active) and (uniSPMerah.RecordCount > 0) then
  begin
...
procedure TfKartuIndukExLD.CRDBGrid1DrawColumnCell(Sender: TObject;
...
procedure TfKartuIndukExLD.CRDBGrid2DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
var
  bitmap : TBitmap;
...
procedure TfKartuIndukExLD.CRDBGrid3DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
var
  bitmap : TBitmap;
...
procedure TfKartuIndukExLD.CRDBGrid4DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
var
  bitmap : TBitmap;
