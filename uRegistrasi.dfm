object fRegistrasi: TfRegistrasi
  Left = 165
  Top = 1
  Align = alClient
  ...
  object cxPageControl1: TcxPageControl
    ...
    object cxTabSheet1: TcxTabSheet
      ...
      object cxPageControl2: TcxPageControl
        ...
        object cxTabSheet3: TcxTabSheet
          ...
          object eDikeluarkanEntry: TcxTextEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 2
            OnKeyDown = eDikeluarkanEntryKeyDown
            Width = 315
          end
          ...
          object eSilinderEntry: TcxTextEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 11
            OnKeyDown = eSilinderEntryKeyDown
            Width = 118
          end
          object eJmlRodaEntry: TcxTextEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 14
            OnKeyDown = eJmlRodaEntryKeyDown
            Width = 118
          end
          object cbBahanBakarEntry: TcxDBLookupComboBox
            ...
            StyleFocused.Color = clAqua
            TabOrder = 16
            OnKeyDown = cbBahanBakarEntryKeyDown
            Width = 269
          end
          object cbPeruntukanEntry: TcxDBLookupComboBox
            ...
            StyleFocused.Color = clAqua
            TabOrder = 18
            OnKeyDown = cbPeruntukanEntryKeyDown
            Width = 269
          end
          object eNRegBPKBEntry: TcxTextEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 1
            OnKeyDown = eNRegBPKBEntryKeyDown
            Width = 337
          end
          object eNoMesinEntry: TcxTextEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 5
            OnKeyDown = eNoMesinEntryKeyDown
            Width = 337
          end
          ...
          object eJmlSumbuEntry: TcxTextEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 15
            OnKeyDown = eJmlSumbuEntryKeyDown
            Width = 118
          end
          ...
          object cbWarnaTNKBEntry: TcxDBLookupComboBox
            ...
            StyleFocused.Color = clAqua
            TabOrder = 20
            OnKeyDown = cbWarnaTNKBEntryKeyDown
            Width = 269
          end
          object dtTglEntry: TcxDateEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 3
            OnKeyDown = dtTglEntryKeyDown
            Width = 139
          end
          object eThnRakitEntry: TcxComboBox
            Left = 551
            Top = 183
            ParentFont = False
            Style.Font.Charset = ANSI_CHARSET
            ...
            StyleFocused.Color = clAqua
            TabOrder = 13
            OnKeyDown = eThnRakitEntryKeyDown
            Width = 118
          end
          object eThnBuatEntry: TcxComboBox
            ...
            StyleFocused.Color = clAqua
            TabOrder = 12
            OnKeyDown = eThnBuatEntryKeyDown
            Width = 118
          end
        ...
        object cxTabSheet4: TcxTabSheet
          ...
          object eAlamatPemilikEntry: TcxMemo
            ...
            StyleFocused.Color = clAqua
            TabOrder = 2
            OnKeyDown = eAlamatPemilikEntryKeyDown
            Height = 97
            Width = 378
          end
          ...
          object cbWilayahEntry: TcxDBLookupComboBox
            ...
            StyleFocused.Color = clAqua
            TabOrder = 6
            OnKeyDown = cbWilayahEntryKeyDown
            Width = 293
          end
          ...
          object ePekerjaanEntry: TcxDBLookupComboBox
            Left = 127
            Top = 270
            DataBinding.DataField = 'pekerjaan_nama'
            DataBinding.DataSource = dsQPekerjaan1
            ParentFont = False
            Properties.CharCase = ecUpperCase
            ...
            Properties.ListColumns = <
              item
                Caption = 'pekerjaan_nama'
                FieldName = 'pekerjaan_nama'
              end>
            Properties.ListOptions.ShowHeader = False
            Properties.ListSource = dsQPekerjaan2
            Style.Font.Charset = ANSI_CHARSET
            Style.Font.Color = clBlack
            Style.Font.Height = -19
            Style.Font.Name = 'Tahoma'
        ...
        object cxTabSheet5: TcxTabSheet
          ...
          object cbJnsDaftaranEntry: TcxDBLookupComboBox
            ...
            StyleFocused.Color = clAqua
            TabOrder = 0
            OnKeyDown = cbJnsDaftaranEntryKeyDown
            Width = 293
          end
          object eNoFakturEntry: TcxTextEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 1
            OnKeyDown = eNoFakturEntryKeyDown
            Width = 338
          end
          object eNoPabeanEntry: TcxTextEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 3
            OnKeyDown = eNoPabeanEntryKeyDown
            Width = 338
          end
          object ePelabuhanEntry: TcxTextEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 5
            OnKeyDown = ePelabuhanEntryKeyDown
            Width = 338
          end
          ...
          object cbCaraImporEntry: TcxDBLookupComboBox
            ...
            StyleFocused.Color = clAqua
            TabOrder = 8
            OnKeyDown = cbCaraImporEntryKeyDown
            Width = 291
          end
          object eNamaImportirEntry: TcxTextEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 10
            OnKeyDown = eNamaImportirEntryKeyDown
            Width = 338
          end
          ...
          object cbPemohonEntry: TcxDBLookupComboBox
            ...
            StyleFocused.Color = clAqua
            TabOrder = 9
            OnKeyDown = cbPemohonEntryKeyDown
            Width = 272
          end
          object dtTglFakturEntry: TcxDateEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 2
            OnKeyDown = dtTglFakturEntryKeyDown
            Width = 139
          end
          object dtTglPabeanEntry: TcxDateEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 4
            OnKeyDown = dtTglPabeanEntryKeyDown
            Width = 139
          end
          object dtTglPIBEntry: TcxDateEdit
            ...
            StyleFocused.Color = clAqua
            TabOrder = 7
            OnKeyDown = dtTglPIBEntryKeyDown
            Width = 139
          end
      ...
      object eResiPembayaran: TcxTextEdit
        ...
        StyleFocused.Color = clAqua
        TabOrder = 8
        OnKeyDown = eResiPembayaranKeyDown
        Width = 315
      end
      ...
      object eNopolAkhir: TcxTextEdit
        ...
        StyleFocused.Color = clAqua
        TabOrder = 13
        OnKeyPress = eNopolAkhirKeyPress
        Width = 50
      end
      ...
      object Cb2D: TcxCheckBox
        Left = 600
        Top = 474
        Caption = 'Sistem Input Barcode 2D'
        TabOrder = 21
        Transparent = True
        Width = 257
      end
  ...
  object dsQWarnaKartu: TUniDataSource
    DataSet = QWarnaKartu
    Left = 752
    Top = 40
  end
  ...
  object QPekerjaan1: TUniQuery
    Connection = DM.dbSrv
    Left = 752
    Top = 235
  end
  object dsQPekerjaan1: TUniDataSource
    DataSet = QPekerjaan1
    Left = 752
    Top = 259
  end
  object dsQPekerjaan2: TUniDataSource
    DataSet = QPekerjaan2
    Left = 784
    Top = 259
  end
  object QPekerjaan2: TUniQuery
    Connection = DM.dbSrv
    Left = 784
    Top = 235
  end
  object QLokasiSTNK1: TUniQuery
    Connection = DM.dbSrv
    Left = 104
    Top = 504
  end
  object dsQLokasiSTNK1: TUniDataSource
    DataSet = QLokasiSTNK1
    Left = 104
    Top = 528
  end
  object dsQLokasiSTNK2: TUniDataSource
    DataSet = QLokasiSTNK2
    Left = 136
    Top = 528
  end
  object QLokasiSTNK2: TUniQuery
    Connection = DM.dbSrv
    Left = 136
    Top = 504
  end
