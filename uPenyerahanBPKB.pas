...
type
  TfPenyerahanBPKB = class(TForm)
    ...
    procedure eCariNoBPKBSerahKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
...
var
  fPenyerahanBPKB: TfPenyerahanBPKB;
...
procedure TfPenyerahanBPKB.RefrezshPemohon;
begin
  UniQuery1.Close;
...
procedure TfPenyerahanBPKB.TampilAwal;
begin
  RefrezshPemohon;
  HapusDataTemp;
  RefreshDataTemp;
...
procedure TfPenyerahanBPKB.HapusDataTemp;
begin
  with DM.Q do
  begin
    Close;
...
procedure TfPenyerahanBPKB.RefreshDataTemp;
begin
  with Q do
  begin
    Close;
...
procedure TfPenyerahanBPKB.FormShow(Sender: TObject);
begin
  TampilAwal;
  RefrezshPemohon;
...
procedure TfPenyerahanBPKB.bBaruClick(Sender: TObject);
begin
  TampilAwal;
end;

procedure TfPenyerahanBPKB.CariData(vCari: String);
begin
  with DM.Q do
  begin
    ...
    try
        ...
        begin
          ...
          begin
            ...
            try
              ...
              begin
                MessageDlgWarning('DATA TIDAK ADA YANG AKAN DICETAK');
              end;
            except on E: Exception do
            begin
      ...
      begin
        ...
        try
          ...
          begin
            MessageDlgWarning('DATA BPKB TIDAK DITEMUKAN');
          end;
        except on E: Exception do
        begin
...
procedure TfPenyerahanBPKB.bGetDataBPKBClick(Sender: TObject);
begin
...
procedure TfPenyerahanBPKB.eCariNoBPKBSerahKeyDown(Sender: TObject;
...
procedure TfPenyerahanBPKB.CRDBGrid1DrawColumnCell(Sender: TObject;
...
procedure TfPenyerahanBPKB.bSimpanSerahClick(Sender: TObject);
begin
...
procedure TfPenyerahanBPKB.SimpanData;
var
  Temp : String;
begin
  with DM.Q do
...
procedure TfPenyerahanBPKB.cxButton1Click(Sender: TObject);
begin
...
procedure TfPenyerahanBPKB.frxReportGetValue(const VarName: String;
  var Value: Variant);
begin
...
procedure TfPenyerahanBPKB.UpdateTChekPoint(vKode,vOPID,vTgl: String);
begin
  with DM.Q1 do
  begin
    Close;
