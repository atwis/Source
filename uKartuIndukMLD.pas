...
uses
  ...
  frxDesgn, DBAccess, MemDS, cxSplitter, cxGrid, dxSkinsCore,
  dxSkinsDefaultPainters, dxSkinscxPCPainter, cxGridLevel,
  cxGridCustomTableView, cxGridTableView, cxGridDBTableView, cxClasses,
  cxGridCustomView, StdCtrls, cxButtons, ExtCtrls, cxDropDownEdit,
  cxLookupEdit, cxDBLookupEdit, cxDBLookupComboBox, cxTextEdit, cxMaskEdit,
  cxCalendar, Grids, DBGrids, CRGrid, ImgList;

type
  TfKartuIndukMLD = class(TForm)
    Label1: TLabel;
    Shape1: TShape;
    Label14: TLabel;
    Label5: TLabel;
...
var
  fKartuIndukMLD: TfKartuIndukMLD;
...
procedure TfKartuIndukMLD.UpdateKartuInduk(vBerkasID, vOPID,
...
procedure TfKartuIndukMLD.FormCreate(Sender: TObject);
begin
...
procedure TfKartuIndukMLD.FormResize(Sender: TObject);
var
  tLebar : Integer;
begin
...
procedure TfKartuIndukMLD.FormShow(Sender: TObject);
var
  tLebar : Integer;
begin
  cxButton8.Click;
...
procedure TfKartuIndukMLD.cxButton8Click(Sender: TObject);
begin
  QOP1.Close;
...
procedure TfKartuIndukMLD.bGetDataKIClick(Sender: TObject);
var
  vOP : integer;
  total, cetak : integer;
begin
  ...
  begin
    Active := False;
    StoredProcName := 'bpkb_get_list_ki_mld';
    try
      Params.Clear;
      ...
      Params.CreateParam(ftString,'v_bbn',ptinput).AsString := '3';
    ...
    begin
      ErrorProgDialog('Error,..bpkb_get_list_ki_mld%uniSPBiru%Error '+E.Message);
    end;
    end;
  end;
  ...
  begin
    ...
    begin
      ErrorProgDialog('Error,..bpkb_get_list_ki_mld%uniSPMerah%Error '+E.Message);
    end;
    end;
  end;
  ...
  begin
    ...
    begin
      ErrorProgDialog('Error,..bpkb_get_list_ki_mld%uniSPHijau%Error '+E.Message);
    end;
    end;
  end;
  ...
  begin
    ...
    try
      ...
      Params.CreateParam(ftString,'v_kdpolres',ptinput).AsString := vPOLRESID;
      Params.CreateParam(ftString,'v_tgl',ptinput).AsString := FormatDateTime('yyyymmdd',dtTglPrintKI.Date); // bbn1
      Params.CreateParam(ftString,'v_bbn',ptinput).AsString := '4';
    ...
    begin
      ErrorProgDialog('Error,..bpkb_get_list_ki_mld%uniSPKuning%Error '+E.Message);
    end;
    end;
  end;
  fWait.Hide;
...
procedure TfKartuIndukMLD.cxGrid1DBTableView1StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
...
procedure TfKartuIndukMLD.cxGridDBTableView1StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  if (ARecord is TcxGridDataRow) and (ARecord.Values[2] = 1) then
...
procedure TfKartuIndukMLD.cxGridDBTableView2StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  if (ARecord is TcxGridDataRow) and (ARecord.Values[2] = 1) then
...
procedure TfKartuIndukMLD.cxGridDBTableView3StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  if (ARecord is TcxGridDataRow) and (ARecord.Values[2] = 1) then
...
procedure TfKartuIndukMLD.bPembuatanBPKBDuplikatClick(Sender: TObject);
begin
...
procedure TfKartuIndukMLD.cxButton1Click(Sender: TObject);
begin
  if (uniSPBiru.Active) and (uniSPBiru.RecordCount > 0) then
  begin
...
procedure TfKartuIndukMLD.cxButton2Click(Sender: TObject);
begin
...
procedure TfKartuIndukMLD.cxButton3Click(Sender: TObject);
begin
  if (uniSPHijau.Active) and (uniSPHijau.RecordCount > 0) then
  begin
...
procedure TfKartuIndukMLD.cxButton4Click(Sender: TObject);
begin
...
procedure TfKartuIndukMLD.cxButton5Click(Sender: TObject);
begin
  if (uniSPKuning.Active) and (uniSPKuning.RecordCount > 0) then
  begin
...
procedure TfKartuIndukMLD.cxButton6Click(Sender: TObject);
begin
...
procedure TfKartuIndukMLD.cxButton7Click(Sender: TObject);
begin
  if (uniSPMerah.Active) and (uniSPMerah.RecordCount > 0) then
  begin
...
procedure TfKartuIndukMLD.CRDBGrid1DrawColumnCell(Sender: TObject;
...
procedure TfKartuIndukMLD.CRDBGrid2DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
var
  bitmap : TBitmap;
...
procedure TfKartuIndukMLD.CRDBGrid3DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
var
  bitmap : TBitmap;
...
procedure TfKartuIndukMLD.CRDBGrid4DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
var
  bitmap : TBitmap;
