...
var
  fPenyerahanDup: TfPenyerahanDup;
...
procedure TfPenyerahanDup.CariData(vCari: String);
begin
  with DM.Q do
  begin
        ...
        begin
          ...
          begin
            ...
            try
              ...
              begin
                MessageDlg('DATA TIDAK ADA YANG AKAN DICETAK',mtWarning,[mbOK],0);
              end;
      ...
      begin
        ...
        try
          ...
          begin
            ...
            begin
              MessageDlg('PROSES TIDAK BISA DILANJUTKAN, DATA BELUM MENGALAMI PROSES PENCETAKAN BUKU BPKB',mtError,[mbOK],0);
            end;
          end
          else
          begin
            MessageDlg('DATA BPKB TIDAK DITEMUKAN',mtWarning,[mbOK],0);
          end;
        except on E: Exception do
        begin
...
procedure TfPenyerahanDup.HapusDataTemp;
begin
  with DM.Q do
  begin
    Close;
...
procedure TfPenyerahanDup.RefreshDataTemp;
begin
  with Q do
  begin
    Close;
...
procedure TfPenyerahanDup.RefrezshPemohon;
begin
  UniQuery1.Close;
...
procedure TfPenyerahanDup.SimpanData;
var
  Temp : String;
begin
  with DM.Q do
...
procedure TfPenyerahanDup.TampilAwal;
begin
  RefrezshPemohon;
  HapusDataTemp;
  RefreshDataTemp;
...
procedure TfPenyerahanDup.UpdateTChekPoint(vKode, vOPID, vTgl: String);
begin
  with DM.Q1 do
  begin
    Close;
...
procedure TfPenyerahanDup.FormShow(Sender: TObject);
begin
  TampilAwal;
  RefrezshPemohon;
...
procedure TfPenyerahanDup.bBaruClick(Sender: TObject);
begin
  TampilAwal;
end;

procedure TfPenyerahanDup.bGetDataBPKBClick(Sender: TObject);
begin
...
procedure TfPenyerahanDup.eCariNoBPKBSerahKeyDown(Sender: TObject;
...
procedure TfPenyerahanDup.bSimpanSerahClick(Sender: TObject);
begin
...
procedure TfPenyerahanDup.cxButton1Click(Sender: TObject);
begin
