...
procedure TfPenulisanBN.CariData;
var
...
procedure TfPenulisanBN.CekSelisihKoordinat(vX, vY: Real; vPage: integer);
var
...
procedure TfPenulisanBN.CetakBukuBPKB;
var
...
procedure TfPenulisanBN.DuplicateDataKoordinat;
begin
  with DM.Q2 do
  begin
    Close;
...
procedure TfPenulisanBN.TampilAwal;
begin
...
procedure TfPenulisanBN.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TfPenulisanBN.FormCloseQuery(Sender: TObject;
  var CanClose: Boolean);
begin
  CanClose := True;
end;

procedure TfPenulisanBN.FormCreate(Sender: TObject);
begin
  fWait.Show;
...
procedure TfPenulisanBN.FormDestroy(Sender: TObject);
begin
...
procedure TfPenulisanBN.FormShow(Sender: TObject);
begin
...
procedure TfPenulisanBN.bCari_CBClick(Sender: TObject);
begin
  ...
  begin
    MessageDlgWarning('FONT BPKB BLM TERINSTALL PADA SISTEM'+#13+
                     'RESTART PC UNTUK MEMAKSIMALKAN PROSES INSTALLASI PADA FONT BPKB'+#13+
                     'TERIMAKASIH');
  end;
end;

procedure TfPenulisanBN.bBaru_CBClick(Sender: TObject);
begin
  TampilAwal;
end;

procedure TfPenulisanBN.bCetakBuku_CBClick(Sender: TObject);
begin
  {fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
  ...
  DuplicateDataKoordinat;
  if (StrToInt(eInfoJmlRoda_CB.Text) = 2) or (StrToInt(eInfoJmlRoda_CB.Text) = 3) then
     vIsCetakTandaTangan := '3'
  else if StrToInt(eInfoJmlRoda_CB.Text) >= 4 then
     vIsCetakTandaTangan := '4';
...
procedure TfPenulisanBN.frxReport_CBBeforePrint(
...
procedure TfPenulisanBN.frxReport_CBGetValue(const VarName: String;
  var Value: Variant);
begin
...
procedure TfPenulisanBN.CetakBukuBPKBPerSatu;
var
  uniSP,uniSP2 : TUniStoredProc;
  vPage : String;
begin
            ...
            try
              ...
              begin
                ...
                try
                  ...
                  begin
                    Log('SP bpkb_get_cetak_buku << ');
                    Log('v_signtype : '+vIsCetakTandaTangan);
                    Log('v_berkas : '+vBPKBIDCetakBuku);
                    Log('end SP bpkb_get_cetak_buku >>');
                  end;
...
procedure TfPenulisanBN.Halaman11Click(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanBN.Halaman21Click(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanBN.Halaman31Click(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanBN.Halaman41Click(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanBN.eNoBPKB_CBKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = 13 then
  begin
...
procedure TfPenulisanBN.eNoRangka_CBKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = 13 then
  begin
...
procedure TfPenulisanBN.eNoBarcode_CBKeyDown(Sender: TObject;
