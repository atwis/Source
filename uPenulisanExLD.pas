...
var
  fPenulisanExLD: TfPenulisanExLD;
...
procedure TfPenulisanExLD.CariData;
var
...
procedure TfPenulisanExLD.CekSelisihKoordinat(vX, vY: Real;
  vPage: integer);
var
...
procedure TfPenulisanExLD.CetakBukuBPKB;
var
...
procedure TfPenulisanExLD.DuplicateDataKoordinat;
begin
  with DM.Q2 do
  begin
    Close;
...
procedure TfPenulisanExLD.TampilAwal;
begin
...
procedure TfPenulisanExLD.FormCreate(Sender: TObject);
begin
  fWait.Show;
...
procedure TfPenulisanExLD.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TfPenulisanExLD.FormCloseQuery(Sender: TObject;
  var CanClose: Boolean);
begin
  CanClose := True;
end;

procedure TfPenulisanExLD.FormDestroy(Sender: TObject);
begin
...
procedure TfPenulisanExLD.FormShow(Sender: TObject);
begin
...
procedure TfPenulisanExLD.bCari_CBClick(Sender: TObject);
begin
...
procedure TfPenulisanExLD.bBaru_CBClick(Sender: TObject);
begin
  TampilAwal;
end;

procedure TfPenulisanExLD.bCetakBuku_CBClick(Sender: TObject);
begin
  {fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanExLD.Halaman11Click(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanExLD.Halaman21Click(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanExLD.Halaman31Click(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanExLD.Halaman41Click(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanExLD.CetakBukuBPKBPerSatu;
var
  uniSP,uniSP2 : TUniStoredProc;
  vPage : String;
begin
...
procedure TfPenulisanExLD.frxReport_CBBeforePrint(
...
procedure TfPenulisanExLD.frxReport_CBGetValue(const VarName: String;
  var Value: Variant);
begin
