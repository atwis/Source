...
uses
  ...
  cxTextEdit, cxMaskEdit, cxCalendar, Grids, DBGrids, CRGrid, ImgList;

type
  TfKartuIndukBN = class(TForm)
    Label1: TLabel;
    Shape1: TShape;
    Label14: TLabel;
    Label5: TLabel;
...
procedure TfKartuIndukBN.FormResize(Sender: TObject);
var
  tLebar : Integer;
begin
...
procedure TfKartuIndukBN.FormShow(Sender: TObject);
var
  tLebar : Integer;
begin
...
procedure TfKartuIndukBN.FormCreate(Sender: TObject);
begin
...
procedure TfKartuIndukBN.cxButton8Click(Sender: TObject);
begin
  QOP1.Close;
...
procedure TfKartuIndukBN.bGetDataKIClick(Sender: TObject);
var
  vOP : integer;
  total, cetak : integer;
begin
...
procedure TfKartuIndukBN.bPembuatanBPKBDuplikatClick(Sender: TObject);
begin
...
procedure TfKartuIndukBN.cxButton1Click(Sender: TObject);
begin
  if (uniSPBiru.Active) and (uniSPBiru.RecordCount > 0) then
  begin
...
procedure TfKartuIndukBN.cxButton2Click(Sender: TObject);
begin
...
procedure TfKartuIndukBN.cxButton3Click(Sender: TObject);
begin
  if (uniSPHijau.Active) and (uniSPHijau.RecordCount > 0) then
  begin
...
procedure TfKartuIndukBN.cxButton4Click(Sender: TObject);
begin
...
procedure TfKartuIndukBN.cxButton5Click(Sender: TObject);
begin
  if (uniSPKuning.Active) and (uniSPKuning.RecordCount > 0) then
  begin
...
procedure TfKartuIndukBN.cxButton6Click(Sender: TObject);
begin
...
procedure TfKartuIndukBN.cxButton7Click(Sender: TObject);
begin
  if (uniSPMerah.Active) and (uniSPMerah.RecordCount > 0) then
  begin
...
procedure TfKartuIndukBN.UpdateKartuInduk(vBerkasID, vOPID,
...
procedure TfKartuIndukBN.cxGrid1DBTableView1StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
...
procedure TfKartuIndukBN.cxGridDBTableView1StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  if (ARecord is TcxGridDataRow) and (ARecord.Values[2] = 1) then
...
procedure TfKartuIndukBN.cxGridDBTableView2StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  if (ARecord is TcxGridDataRow) and (ARecord.Values[2] = 1) then
...
procedure TfKartuIndukBN.cxGridDBTableView3StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
  if (ARecord is TcxGridDataRow) and (ARecord.Values[2] = 1) then
...
procedure TfKartuIndukBN.CRDBGrid1DrawColumnCell(Sender: TObject;
...
procedure TfKartuIndukBN.CRDBGrid2DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
var
  bitmap : TBitmap;
...
procedure TfKartuIndukBN.CRDBGrid3DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
var
  bitmap : TBitmap;
...
procedure TfKartuIndukBN.CRDBGrid4DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
var
  bitmap : TBitmap;
