...
// Encoding : utf-8
// Version  : 1.0
// (14/03/2014 11:30:12 - - $Rev: 56641 $)
// ************************************************************************ //

unit AtpmDataService2;
...
type
  ...
  published
    ...
    property BahanBakar:     string  read FBahanBakar write FBahanBakar;
    property Jenis:          string  read FJenis write FJenis;
    property Model:          string  read FModel write FModel;
    property Merk:           string  read FMerk write FMerk;
    property Tipe:           string  read FTipe write FTipe;
    property TahunBuat:      string  read FTahunBuat write FTahunBuat;
    property TahunRakit:     string  read FTahunRakit write FTahunRakit;
    property Sumbu:          string  read FSumbu write FSumbu;
    property JumlahRoda:     string  read FJumlahRoda write FJumlahRoda;
    property VolumeSilinder: string  read FVolumeSilinder write FVolumeSilinder;
  end;
