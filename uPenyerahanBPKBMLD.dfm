object fPenyerahanMLD: TfPenyerahanMLD
  Left = 402
  Top = 125
  Align = alClient
  ...
  object Label1: TLabel
    ...
    Width = 373
    Height = 23
    Caption = 'Penyerahan BPKB - Mutasi Luar Daerah'
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    Font.Height = -19
    Font.Name = 'Tahoma'
  ...
  object Q: TUniQuery
    ...
    object Qbpkb_id: TIntegerField
      FieldName = 'bpkb_id'
      Required = True
    end
    object Qberkas_id: TIntegerField
      FieldName = 'berkas_id'
      Required = True
    end
    object Qno_bpkb: TStringField
      FieldName = 'no_bpkb'
    end
    object Qnreg_bpkb: TStringField
      FieldName = 'nreg_bpkb'
      Size = 30
    end
    object Qtgl_bpkb: TDateField
      FieldName = 'tgl_bpkb'
    end
    object Qnama_pemilik: TStringField
      FieldName = 'nama_pemilik'
      Size = 150
    end
    object Qalamat_pemilik: TStringField
      FieldName = 'alamat_pemilik'
      Size = 255
    end
    object Qno_identitas: TStringField
      FieldName = 'no_identitas'
      Size = 60
    end
    object Qno_polisi: TStringField
      FieldName = 'no_polisi'
      Size = 10
    end
    object Qmerk: TStringField
      FieldName = 'merk'
      Size = 30
    end
    object Qtipe: TStringField
      FieldName = 'tipe'
      Size = 30
    end
    object Qjenis: TStringField
      FieldName = 'jenis'
      Size = 30
    end
    ...
    object Qno_rangka: TStringField
      FieldName = 'no_rangka'
      Size = 30
    end
    object Qno_mesin: TStringField
      FieldName = 'no_mesin'
      Size = 30
    end
    object Qno_faktur: TStringField
      FieldName = 'no_faktur'
      Size = 30
    end
    object Qtgl_faktur: TDateField
      FieldName = 'tgl_faktur'
    end
    object Qpemohon_id: TIntegerField
      FieldName = 'pemohon_id'
    end
    object Qpemohon_nama: TStringField
      FieldName = 'pemohon_nama'
      Size = 255
    end
    object Qcatatan: TStringField
      FieldName = 'catatan'
      Size = 255
    end
    object Qtgl_serah: TDateField
      FieldName = 'tgl_serah'
    end
  end
