...
uses
  ...
  cxContainer, cxEdit, dxSkinsCore, dxSkinsDefaultPainters, Menus, Math,
  dxSkinscxPCPainter, frxClass, frxDBSet, DB, MemDS, DBAccess, Uni,
  frxBarcode, frxDesgn, cxMemo, cxPC, StdCtrls, cxButtons, cxTextEdit,
  ExtCtrls, cxMaskEdit, cxDropDownEdit, cxCalendar;

type
  TfPenulisanBBN1 = class(TForm)
    Label1: TLabel;
    Shape1: TShape;
    Label2: TLabel;
    Label3: TLabel;
    ...
    Label46: TLabel;
    Label47: TLabel;
    eInfoTipe2_CB: TcxTextEdit;
    eTglBpkb2: TcxTextEdit;
...
var
  fPenulisanBBN1: TfPenulisanBBN1;
...
procedure TfPenulisanBBN1.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TfPenulisanBBN1.FormCloseQuery(Sender: TObject;
  var CanClose: Boolean);
begin
  CanClose := True;
end;

procedure TfPenulisanBBN1.FormCreate(Sender: TObject);
begin
  fWait.Show;
...
procedure TfPenulisanBBN1.FormDestroy(Sender: TObject);
begin
...
procedure TfPenulisanBBN1.FormShow(Sender: TObject);
begin
  ...
  eInfoTipe2_CB.Style.Font.Name := vNamaFont;
...
procedure TfPenulisanBBN1.TampilAwal;
begin
...
procedure TfPenulisanBBN1.bBaru_CBClick(Sender: TObject);
begin
  TampilAwal;
end;

procedure TfPenulisanBBN1.CariData;
var
    ...
    try
      ...
      begin
        ...
        begin
          ...
          eTglBpkb2.Text := uniSP.FieldByName('TGL_BPKB2').Text;
          ...
          eInfoTipe2_CB.Text := uniSP.FieldByName('TIPE2').Text;
          ...
          begin
            ...
            vPagePosisi := 0;
            bCetakBuku_CB.Enabled := False;
            MessageDlgInformation('Proses Pencetakan buku tidak bisa dilakukan'+#13+
                                  'Buku sudah dicetak');
            eNoBPKB_CB.SetFocus;
          end
          else
        ...
        begin
          fWait.Hide;
          Application.ProcessMessages;
          MessageDlgError('BERKAS BPKB '+eNoBPKB_CB.Text+' BELUM BISA DICETAK'+#13+
                          'PROSES PENCETAKAN BLM MENDAPATKAN IJIN DARI DIREKTUR');
        end;
      end
      else
      begin
...
procedure TfPenulisanBBN1.bCari_CBClick(Sender: TObject);
begin
  ...
  begin
    MessageDlgError('FONT BPKB BLM TERINSTALL PADA SISTEM'+#13+
                    'RESTART PC UNTUK MEMAKSIMALKAN PROSES INSTALLASI PADA FONT BPKB'+#13+
                    'TERIMAKASIH');
  end;
end;

procedure TfPenulisanBBN1.CekSelisihKoordinat(vX, vY: Real;
  vPage: integer);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      Close;
      SQL.Text := 'select X2,Y2,ELM_IDENTIFIER,X,Y from t_prnbook_coord_temp where page_no=:page and cfg_id=:cfg_id order by titik_awal_ukur desc, y asc';
      ...
      begin
        ...
        begin
          Q3.Close;
          Q3.SQL.Text := 'update t_prnbook_coord_temp set X=:X,Y=:Y where ELM_IDENTIFIER=:ELM_IDENTIFIER and cfg_id=:cfg_id and page_no=:page';
          ...
          Q3.Params[4].AsString := IntToStr(vPage);
          Q3.Execute;
        end
        else
        begin
      ...
      {if tJmlLebihToleransi > 0 then
      begin
        fWait.Close;
        Application.ProcessMessages;
        MessageDlg('PROSES PENCETAKAN TIDAK BISA DILANJUTKAN'+#13+
                   'KOORDINAT PENCETAKAN MELEBIHI BATAS KOORDINAT YANG DITENTUKAN',mtError,[mbOK],0);
      end
      else if tJmlLebihToleransi = 0 then
      begin
        if isPersatu='1' then
           CetakBukuBPKBPerSatu
        else
    ...
    begin
      MessageDlgError('Proses setting ukuran tidak bisa dilakukan, data tidak ada');
    end;
  end;
end;

procedure TfPenulisanBBN1.DuplicateDataKoordinat;
begin
  with DM.Q2 do
  begin
    Close;
...
procedure TfPenulisanBBN1.bCetakBuku_CBClick(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanBBN1.CetakBukuBPKB;
var
          ...
          begin
            ...
            try
              ...
              begin
                ...
                uniSPCetak.StoredProcName := 'bpkb_get_cetak_buku2';
                try
                  ...
                  uniSPCetak.Params.CreateParam(ftString,'v_tgl_berkas',ptinput).AsString := eTglBpkb2.Text;
                  ...
                  begin
                    ...
                    begin
                      ...
                      MessageDlgInformation('Lanjut ke pencetakan halaman ke - 2');
                      {eX1_CB.Enabled := False;
                      eY1_CB.Enabled := False;
                      eX2_CB.Enabled := True;
                      eY2_CB.Enabled := True;
                    ...
                    begin
                      ...
                      MessageDlgInformation('Lanjut ke pencetakan halaman ke - 3');
                      {eX1_CB.Enabled := False;
                      eY1_CB.Enabled := False;
                      eX2_CB.Enabled := False;
                      eY2_CB.Enabled := False;
                    ...
                    begin
                      ...
                      MessageDlgInformation('Lanjut ke pencetakan halaman ke - 4');
                      {eX1_CB.Enabled := False;
                      eY1_CB.Enabled := False;
                      eX2_CB.Enabled := False;
                      eY2_CB.Enabled := False;
                    ...
                    begin
                      ...
                      MessageDlgInformation('Proses pencetakan selesai!');
                      {eX1_CB.Enabled := False;
                      eY1_CB.Enabled := False;
                      eX2_CB.Enabled := False;
                      eY2_CB.Enabled := False;
                  ...
                  begin
                    fWait.Hide;
                    Application.ProcessMessages;
                    MessageDlgInformation('Tidak ada data yg akan dicetak');
                  end;
                except on E: Exception do
                begin
              ...
              begin
                fWait.Hide;
                Application.ProcessMessages;
                MessageDlgInformation('Proses update cek point gagal');
              end;
            except on E: Exception do
            begin
...
procedure TfPenulisanBBN1.frxReport_CBBeforePrint(
  Sender: TfrxReportComponent);
begin
  Log('Start Print BPKB');
  with Q do
  begin
    if vPagePosisi=1 then
    begin
...
procedure TfPenulisanBBN1.frxReport_CBGetValue(const VarName: String;
  var Value: Variant);
begin
...
procedure TfPenulisanBBN1.Halaman11Click(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanBBN1.Halaman21Click(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanBBN1.Halaman31Click(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanBBN1.Halaman41Click(Sender: TObject);
begin
  fWait.Show;
  fWait.Label1.Caption := 'Tunggu Sebentar ...';
  fWait.cxProgressBar1.Visible := True;
...
procedure TfPenulisanBBN1.CetakBukuBPKBPerSatu;
var
  uniSP,uniSP2 : TUniStoredProc;
  vPage : String;
begin
...
procedure TfPenulisanBBN1.eNoBPKB_CBKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = 13 then
  begin
...
procedure TfPenulisanBBN1.eNoRangka_CBKeyDown(Sender: TObject;
...
procedure TfPenulisanBBN1.eNoBarcode_CBKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  if Key = 13 then
  begin
