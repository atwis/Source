...
var
  fPenyerahanMLD: TfPenyerahanMLD;
...
procedure TfPenyerahanMLD.CariData(vCari: String);
begin
  with DM.Q do
  begin
...
procedure TfPenyerahanMLD.frxReportGetValue(const VarName: String;
  var Value: Variant);
begin
...
procedure TfPenyerahanMLD.HapusDataTemp;
begin
  with DM.Q do
  begin
    Close;
...
procedure TfPenyerahanMLD.RefreshDataTemp;
begin
  with Q do
  begin
    Close;
...
procedure TfPenyerahanMLD.RefrezshPemohon;
begin
  UniQuery1.Close;
...
procedure TfPenyerahanMLD.SimpanData;
var
  Temp : String;
begin
  with DM.Q do
...
procedure TfPenyerahanMLD.TampilAwal;
begin
  RefrezshPemohon;
  HapusDataTemp;
  RefreshDataTemp;
...
procedure TfPenyerahanMLD.UpdateTChekPoint(vKode, vOPID, vTgl: String);
begin
  with DM.Q1 do
  begin
    Close;
